...
def color_detect(msg):
    if start_recognition == True:
        ...
        mask_red2 = cv2.inRange(hsv, (172, 59, 122), (179, 220, 206))
        mask_red = cv2.bitwise_or(mask_red1, mask_red2)
        mask_blue = cv2.inRange(hsv, (95,52,101), (113,212,174))
        mask_green1 = cv2.inRange(hsv, (72, 37, 70), (88, 197, 190))
        mask_green2 = cv2.inRange(hsv, (70, 79, 49), (87, 243, 90))
        mask_green = cv2.bitwise_or(mask_green1, mask_green2)
        mask_yellow = cv2.inRange(hsv, (22,90,126), (29, 253, 169))
        mask_orange= cv2.inRange(hsv, (0, 74, 113), (11, 212, 201))
...
navigate_wait(x=0.5, y=0.5, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
...
navigate_wait(x=0.5, y=0.5, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=3, y=0.5, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=3, y=1, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=0.5, y=1, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=0.5, y=1.5, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=3, y=1.5, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=3, y=2, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=0.5, y=2, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=0.5, y=2.5, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=3, y=2.5, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=3, y=3, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
navigate_wait(x=0.5, y=3, z=0.5, frame_id='aruco_map', speed=0.5)
rospy.sleep(0.5)
